...
class busAvailability extends Component {
  ...
  onSetFilter = () => {
    ...
    if(this.state.timeSort == '00:00-12:00'){
      ...
      this.state.busesArrayAfterBusTypeSelection.forEach(item => {
        if(parseInt(item[9].split(':')[0]) < 12 && parseInt(item[9].split(':')[0]) >= 18){
          finalArr = [...finalArr , item];
        }
      })
    } else{
    ...
    return (
      <TouchableOpacity 
          onPress={()=> {
            ...
            this.props.navigation.navigate('seatSelection', {scheduleId : item[0] , busDetails : busDetails, date:this.state.searchDate, apiDate:this.state.date, title:this.props.route.params.title, depTime:item[9], originId : this.props.route.params.originId, destId : this.props.route.params.destId })
          }} 
          style={[styles.eachContainer, {flexDirection:'column'}]}>
        <View style={styles.rowContent}>
          <View style={[styles.blueButton, {flex:1}]}>
            <Text style={styles.whiteContent}>{item[3]}</Text>
          </View>
        </View>
          ...
          <View style={{flex:1,justifyContent:'flex-end', backgroundColor:'rgba(0,0,0,0.2)'}}>
            <View style={{backgroundColor:'#fff',padding:20, borderTopLeftRadius:20,borderTopRightRadius:20, width:'100%',justifyContent:'center', height:480 }}>
              ...
              <View style={{ borderBottomWidth : 0.5,paddingBottom:25, borderColor:'gray', padding:5}}>
                ...
                <TouchableOpacity onPress={() => {this.setState({ priceSort:'LTH' }) }} style={{flex:1,flexDirection:'row', alignItems:'center', paddingVertical:15, borderColor : '#dcdcdc', borderWidth:0.1}}>
                ...
                <TouchableOpacity onPress={() => {this.setState({ priceSort:'HTL' }) }} style={{flex:1,flexDirection:'row', alignItems:'center', paddingVertical:15, borderColor : '#dcdcdc', borderWidth:0.1}}>
              ...
              <View style={{ borderBottomWidth : 0.5,paddingBottom:25, borderColor:'gray', padding:5}}>
                ...
                <TouchableOpacity onPress={() => {this.setState({ priceSort:'Asc' }) }} style={{flex:1,flexDirection:'row', alignItems:'center', paddingVertical:15, borderColor : '#dcdcdc', borderWidth:0.1}}>
                ...
                <TouchableOpacity onPress={() => {this.setState({ priceSort:'Desc' }) }} style={{flex:1,flexDirection:'row', alignItems:'center', paddingVertical:15, borderColor : '#dcdcdc', borderWidth:0.1}}>
              ...
              <View style={{ marginTop:10}}>
                ...
                <TouchableOpacity onPress={() => {this.setState({ timeSort:'00:00-12:00' }) }} style={{flex:1,flexDirection:'row', alignItems:'center', paddingVertical:15, borderColor : '#dcdcdc', borderWidth:0.1}}>
                ...
                <TouchableOpacity onPress={() => {this.setState({ timeSort:'12:00-18:00' }) }} style={{flex:1,flexDirection:'row', alignItems:'center', paddingVertical:15, borderColor : '#dcdcdc', borderWidth:0.1}}>
                ...
                <TouchableOpacity onPress={() => {this.setState({ timeSort:'18:00-24:00' }) }} style={{flex:1,flexDirection:'row', alignItems:'center', paddingVertical:15, borderColor : '#dcdcdc', borderWidth:0.1}}>
          ...
          <ScrollView showsVerticalScrollIndicator = {false}>
            <View style={styles.eachContainer}>
              <TouchableOpacity onPress={() => this.onDateBefore()} style={styles.centerView}>
                <Image style={styles.smallIcon} source={Images.leftArrow} />
              </TouchableOpacity>
            ...
            {availabilityArray[0] ? (
              <View style={[styles.centerView, { margin : hp(15) }]}>
