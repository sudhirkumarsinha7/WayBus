        ...
        <View style={styles.locationContainer}>
          <View style={{flex: 1}}>
            ...
            <View>
              ...
              <Text style={styles.grayContent}>
                Growing a large online bus ticketing platform and trusted travel
                brand of India, our strengths include a large and trustworthy
                customer base and business travellers a strong technology
                platform designed to deliver a high level of scalability and
                innovation travel industry in India.
              </Text>

              <View style={{marginTop: 50}}>
                <Text
                style={{color: 'blue', marginLeft: 8, fontWeight: 'bold'}}
